#!/usr/bin/env bash
# L/2 + MAE-640 + version_b + cfg_sample_ratio + TEMP×2 (8x RTX 5090, GPU 0..7)
#   batch_size=4 (workspace launch). wandb project: "ImageNet - L2".
set -euo pipefail

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"

CONFIG="${ROOT}/configs/gen/L2_fwd-drift.yaml"
WORKDIR="${WORKDIR:-${ROOT}/runs/gen_L2_version_b_cfgratio_temp2x_mae640_ncls8_gpu01234567_neg32}"
LOG_DIR="${ROOT}/runs/launch_logs"
LOG_FILE="${LOG_DIR}/L2_version_b_cfgratio_temp2x_mae640_ncls8_gpu01234567_neg32.log"
PID_FILE="${LOG_DIR}/pid_L2_version_b_cfgratio_temp2x_mae640_ncls8_gpu01234567_neg32"
...
echo "[launch] L/2 version_b + cfg_sample_ratio + TEMP×2 (8 GPU, mae640, bs=4)"

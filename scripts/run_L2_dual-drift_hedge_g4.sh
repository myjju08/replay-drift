#!/usr/bin/env bash
# L/2 + MAE-640 + mixed_baseline_versionb + ADAPTIVE hedge (preset 2 = data-driven, γ=4)
#   gamma=4.0, eta=1e-4, decay=1e-4, gamma_warmup_steps=10000
...
CONFIG="${ROOT}/configs/gen/L2_dual-drift_hedge_g4.yaml"
WORKDIR="${WORKDIR:-${ROOT}/runs/gen_L2_mix_adaptive_hedge_g4_mae640_ncls8_gpu01234567_neg32}"
LOG_DIR="${ROOT}/runs/launch_logs"
LOG_FILE="${LOG_DIR}/L2_mix_adaptive_hedge_g4_mae640_ncls8_gpu01234567_neg32.log"
PID_FILE="${LOG_DIR}/pid_L2_mix_adaptive_hedge_g4_mae640_ncls8_gpu01234567_neg32"

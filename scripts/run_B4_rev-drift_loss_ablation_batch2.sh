#!/usr/bin/env bash
# Remaining necessity ablations plus direct raw-latent emphasis, four 2-GPU runs.
set -euo pipefail
...
PROFILES=(no_stage2 no_stage3 no_stage4 global_x8)
LABELS=(no_stage2 no_stage3 no_stage4 global_x8)
GPU_GROUPS=(0,1 2,3 4,5 6,7)
PORTS=(29720 29721 29722 29723)
...
for index in "${!PROFILES[@]}"; do
  ...
  echo "[batch2] launching ${label} on GPUs ${GPU_GROUPS[$index]}"
...
echo "[batch2] launched all four ablations"
for label in "${LABELS[@]}"; do
  echo "[batch2] tail -f ${ROOT}/runs/launch_logs/gen_B4_revdrift_mae256_lossabl_p32_n16_${label}_${ABLATION_TAG}.log"
done

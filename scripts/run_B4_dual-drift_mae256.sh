#!/usr/bin/env bash
# B/4 generator + official full-resolution latent MAE-256 + adaptive dual drift.
# Matched to run_B2_dual-drift.sh except for generator patch size and MAE width.
set -euo pipefail
...
WORKDIR="${WORKDIR:-${ROOT}/runs/gen_B4_dualdrift_mae256_dense}"
...
echo "[launch] B/4 + official full-resolution latent MAE-256 + adaptive dual drift"
